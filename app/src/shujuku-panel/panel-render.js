...
.igs-shujuku-table th{padding:7px 10px;text-align:left;font-size:11px;font-weight:600;color:rgba(255,255,255,.4);border-bottom:1px solid rgba(255,255,255,.1);position:sticky;top:0;z-index:1;background:var(--igs-db-head-bg,var(--igs-db-bg,rgba(20,20,22,.62)));-webkit-backdrop-filter:blur(32px) saturate(180%);backdrop-filter:blur(32px) saturate(180%);white-space:nowrap;}
