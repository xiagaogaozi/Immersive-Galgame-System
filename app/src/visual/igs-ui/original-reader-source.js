...
.igs-option-bubble{pointer-events:auto;cursor:pointer;border:1px solid var(--igs-choice-border,rgba(255,255,255,.14));background:var(--igs-choice-bg,var(--igs-glass-bg,rgba(20,20,22,.62)));-webkit-backdrop-filter:var(--igs-choice-blur,blur(32px) saturate(180%));backdrop-filter:var(--igs-choice-blur,blur(32px) saturate(180%));border-radius:var(--igs-choice-radius,18px);padding:10px 16px;color:#f4f4f6;font-size:14px;line-height:1.5;text-shadow:0 1px 3px rgba(0,0,0,.92),0 0 8px rgba(0,0,0,.7);box-shadow:var(--igs-choice-shadow,0 2px 10px rgba(0,0,0,.14));max-width:100%;word-break:break-word;transition:background .15s,transform .1s;}
.igs-option-bubble:hover{background:rgba(60,60,66,.32);}
.igs-option-bubble:active{transform:scale(.97);}
.igs-dialog{position:absolute;left:50%;bottom:24px;transform:translateX(-50%);width:min(880px,calc(100vw - 32px));background:var(--igs-dialog-bg,var(--igs-glass-bg,rgba(20,20,22,.62)));border:1px solid var(--igs-dialog-border,rgba(255,255,255,.14));-webkit-backdrop-filter:var(--igs-dialog-blur,blur(32px) saturate(180%));backdrop-filter:var(--igs-dialog-blur,blur(32px) saturate(180%));border-radius:var(--igs-dialog-radius,22px);box-shadow:var(--igs-dialog-shadow,0 12px 48px rgba(0,0,0,.50));padding:22px 26px 18px;z-index:4;overflow:visible;pointer-events:auto;transition:opacity .3s,transform .3s;}
...
.igs-ctrl-bar{position:absolute;top:-50px;right:0;display:flex;gap:6px;z-index:5;padding:6px;background:var(--igs-toolbar-bg,var(--igs-glass-bg,rgba(20,20,22,.62)));border:1px solid var(--igs-toolbar-border,rgba(255,255,255,.14));-webkit-backdrop-filter:var(--igs-toolbar-blur,blur(32px) saturate(180%));backdrop-filter:var(--igs-toolbar-blur,blur(32px) saturate(180%));border-radius:var(--igs-toolbar-radius,18px);box-shadow:var(--igs-toolbar-shadow,0 4px 24px rgba(0,0,0,.20));pointer-events:auto;transition:opacity .3s;}
