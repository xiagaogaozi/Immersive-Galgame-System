...
export function createImmersiveGalgameSystemReaderHost(options = {}) {
    const state = {
        activeReader: null,
        activeSettings: null,
    };
    ...
    function buildReaderSnapshot(payload, mode, readerSettings, index = 0) {
        ...
        const extracted = buildImmersiveGalgameSystemTextPayload(payload.message || payload.raw || '', {
    ...
    function normalizeVnTheme(value) {
        ...
        const fallback = IGS_THEME_PRESETS[normalized.preset] || IGS_THEME_PRESETS.genshin;
    ...
    function buildRegexPreview(bridge) {
        ...
        const payload = buildImmersiveGalgameSystemTextPayload(previewMessage, {
            sourceFilter: filter,
            virtualRegex,
        });
