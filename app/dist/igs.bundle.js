...
const { cloneData, esc, firstDefined, firstNonEmptyString, firstRenderableText, normalizeBoolean, normalizeFiniteIndex, normalizeFiniteNumber, normalizeNullableNumber, normalizeOpacity, toHex } = require("src/visual/igs-ui/reader-value-utils.js");
...
function applyTransparentGlassMaterial(target, density) {
...
const { parseTables } = require("src/shujuku-panel/panel-model.js");
// 约定的选项表名：命中任一即作为选项来源。
const OPTION_TABLE_NAMES = Object.freeze(['选项', '选项表', '行动选项']);
