...
const { ORIGINAL_READER_ICONS, ORIGINAL_READER_TOOLBAR_BUTTONS } = require("src/visual/igs-ui/original-reader-source.js");const { TOOLBAR_ACTIONS } = require("src/visual/igs-ui/reader-host-constants.js");const { ensureImageLoadingSpinner, ensureImageEmptyPlaceholder, getOwnerWindow, readElementWidth, removeImageEmptyPlaceholder, removeImageLoadingSpinner } = require("src/visual/igs-ui/reader-dom-utils.js");const { computeLineHeight, normalizeOpacity, igsDebug } = require("src/visual/igs-ui/reader-value-utils.js");const { renderDialogueHtml, resolveActiveTheme, resolveSpriteLayout } = require("src/visual/igs-ui/settings-normalize.js");const { applyReaderModeRuntime } = require("src/visual/igs-ui/reader-runtime.js");
