...
const { buildMoodGroupsText, MOOD_GROUPS_PLACEHOLDER } = require("src/scene/mood-groups.js");
...
const { buildIgsTextPayload, getMessagePrimaryText, normalizeSourceFilter, normalizeVirtualRegex } = require("src/scene/message-source.js");const { resolveSceneStateAtIndex, lookupSceneAssetUrls } = require("src/scene/scene-directives.js");const { normalizeMoodGroups } = require("src/scene/mood-groups.js");const { getOriginalReaderHtml, getOriginalReaderSource, getOriginalReaderStyleText, ORIGINAL_READER_REQUIRED_SELECTORS, ORIGINAL_READER_STYLE_CONTRACT } = require("src/visual/igs-ui/original-reader-source.js");const { getSettingsShellTemplate } = require("src/visual/igs-ui/settings-shell.js");const { getSettingsStyleText } = require("src/visual/igs-ui/settings-style.js");const { getSettingsTabTemplate, SETTINGS_TAB_DEFS } = require("src/visual/igs-ui/settings-tabs.js");const { getReaderModeIcon } = require("src/visual/igs-ui/icons.js");const { DEFAULT_IMAGE_API, DEFAULT_PINNED_TOOLBAR_BUTTONS, DEFAULT_SCENE_PROMPT_RULE, READER_SETTINGS_SCHEMA_VERSION, SETTINGS_PANEL_REQUIRED_SELECTORS, SETTINGS_PANEL_TAB_CONTRACT, TOOLBAR_ACTIONS, VN_THEME_PRESETS } = require("src/visual/igs-ui/reader-host-constants.js");const { cloneData, esc, firstDefined, firstNonEmptyString, firstRenderableText, normalizeBoolean, normalizeFiniteIndex, normalizeFiniteNumber, normalizeNullableNumber, normalizeOpacity, toHex } = require("src/visual/igs-ui/reader-value-utils.js");const { checkbox, colorInput, field, renderCharacterAssetList, renderMoodGroupsEditor, renderPinnedButtons, renderSceneAssetList, renderTemplate, secretInput, segmentedInput, selectInput, textInput, textareaInput, numberInput, disabledAttr, modelPicker } = require("src/visual/igs-ui/settings-fields.js");const { applyImageCountOverride, buildImageActionContext, buildProgressText, countBoundImageSlots, normalizePollAttempts, normalizePollInterval, normalizeSnapshotImageState, resolveSegmentImageIndex, shouldPollReaderImages, waitForReaderImagePoll } = require("src/visual/igs-ui/reader-image-state.js");const { attachSettingsViewportEvents, clearChildren, detachSettingsViewportEvents, ensureImageLoadingSpinner, ensureStyleTag, getOwnerWindow, getRootDocument, removeImageLoadingSpinner, syncSettingsViewportVars, unmountNode } = require("src/visual/igs-ui/reader-dom-utils.js");const { buildTextSegments, getPath, normalizeBtnOrder, normalizeHiddenButtons, normalizePinnedButtons, normalizeReaderMode, normalizeSettingsTab, normalizeSettingsValue, normalizeSpriteLayouts, setPath } = require("src/visual/igs-ui/settings-normalize.js");const { clearReaderModeRuntime, exitDocumentFullscreen } = require("src/visual/igs-ui/reader-runtime.js");const { enterSpriteEditMode } = require("src/visual/igs-ui/sprite-edit.js");const { handleSettingsAction: runSettingsAction } = require("src/visual/igs-ui/settings-actions.js");const { applyReaderSnapshotToDom, applyToolbarState, buildFallbackReaderOverlay, buildFallbackSettingsOverlay } = require("src/visual/igs-ui/reader-dom-render.js");
...
}function renderMoodGroupsEditor(moodGroups) {
    const pencil = '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>';
    const trash = '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>';
...
__igsDefine(exports, "renderMoodGroupsEditor", () => renderMoodGroupsEditor);
...
const { ORIGINAL_READER_ICONS, ORIGINAL_READER_TOOLBAR_BUTTONS } = require("src/visual/igs-ui/original-reader-source.js");const { TOOLBAR_ACTIONS } = require("src/visual/igs-ui/reader-host-constants.js");const { ensureImageLoadingSpinner, ensureImageEmptyPlaceholder, getOwnerWindow, readElementHeight, readElementWidth, removeImageEmptyPlaceholder, removeImageLoadingSpinner } = require("src/visual/igs-ui/reader-dom-utils.js");const { computeLineHeight, normalizeOpacity, igsDebug } = require("src/visual/igs-ui/reader-value-utils.js");const { renderDialogueHtml, resolveActiveTheme, resolveSpriteLayout } = require("src/visual/igs-ui/settings-normalize.js");const { applyReaderModeRuntime } = require("src/visual/igs-ui/reader-runtime.js");
