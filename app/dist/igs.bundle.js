...
const { createQrEntry } = require("src/host/qr-entry.js");
...
__igsRegister("src/host/qr-entry.js", function(module, exports, require) {
const { getTavernHelper } = require("src/host/tavern-helper-adapter.js");
...
function createQrEntry(options = {}) {
    const globalObject = options.global || globalThis.window || globalThis;
    const label = options.label || '沉浸式Galgame系统';
    const open = typeof options.open === 'function' ? options.open : null;
    const resolveMode = typeof options.resolveMode === 'function' ? options.resolveMode : () => 'pc';
...
__igsDefine(exports, "createQrEntry", () => createQrEntry);
});
