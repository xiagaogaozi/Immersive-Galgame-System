...
const { buildVisualNovelTextPayload, getMessagePrimaryText, normalizeSourceFilter, normalizeVirtualRegex } = require("src/scene/message-source.js");const { resolveSceneStateAtIndex, lookupSceneAssetUrls } = require("src/scene/scene-directives.js");const { getOriginalReaderHtml, getOriginalReaderSource, getOriginalReaderStyleText, ORIGINAL_READER_REQUIRED_SELECTORS, ORIGINAL_READER_STYLE_CONTRACT } = require("src/visual/visual-novel-ui/original-reader-source.js");const { getSettingsShellTemplate } = require("src/visual/visual-novel-ui/settings-shell.js");const { getSettingsStyleText } = require("src/visual/visual-novel-ui/settings-style.js");const { getSettingsTabTemplate, SETTINGS_TAB_DEFS } = require("src/visual/visual-novel-ui/settings-tabs.js");const { getReaderModeIcon } = require("src/visual/visual-novel-ui/icons.js");const { DEFAULT_IMAGE_API, DEFAULT_PINNED_TOOLBAR_BUTTONS, DEFAULT_SCENE_PROMPT_RULE, READER_SETTINGS_SCHEMA_VERSION, SETTINGS_PANEL_REQUIRED_SELECTORS, SETTINGS_PANEL_TAB_CONTRACT, TOOLBAR_ACTIONS, VN_THEME_PRESETS } = require("src/visual/visual-novel-ui/reader-host-constants.js");const { cloneData, esc, firstDefined, firstNonEmptyString, firstRenderableText, normalizeBoolean, normalizeFiniteIndex, normalizeFiniteNumber, normalizeNullableNumber, normalizeOpacity, stripSpeakerPrefix, toHex } = require("src/visual/visual-novel-ui/reader-value-utils.js");const { checkbox, colorInput, field, renderCharacterAssetList, renderPinnedButtons, renderSceneAssetList, renderTemplate, secretInput, segmentedInput, selectInput, textInput, textareaInput, numberInput, disabledAttr, modelPicker } = require("src/visual/visual-novel-ui/settings-fields.js");const { applyImageCountOverride, buildImageActionContext, buildProgressText, countBoundImageSlots, normalizePollAttempts, normalizePollInterval, normalizeSnapshotImageState, resolveSegmentImageIndex, shouldPollReaderImages, waitForReaderImagePoll } = require("src/visual/visual-novel-ui/reader-image-state.js");const { attachSettingsViewportEvents, clearChildren, detachSettingsViewportEvents, ensureImageLoadingSpinner, ensureStyleTag, getOwnerWindow, getRootDocument, removeImageLoadingSpinner, syncSettingsViewportVars, unmountNode } = require("src/visual/visual-novel-ui/reader-dom-utils.js");const { buildTextSegments, getPath, normalizeBtnOrder, normalizeHiddenButtons, normalizePinnedButtons, normalizeReaderMode, normalizeSettingsTab, normalizeSettingsValue, normalizeSpriteLayouts, setPath } = require("src/visual/visual-novel-ui/settings-normalize.js");const { clearReaderModeRuntime, exitDocumentFullscreen } = require("src/visual/visual-novel-ui/reader-runtime.js");const { enterSpriteEditMode } = require("src/visual/visual-novel-ui/sprite-edit.js");const { handleSettingsAction: runSettingsAction } = require("src/visual/visual-novel-ui/settings-actions.js");const { applyReaderSnapshotToDom, applyToolbarState, buildFallbackReaderOverlay, buildFallbackSettingsOverlay } = require("src/visual/visual-novel-ui/reader-dom-render.js");
...
__vnRegister("src/visual/visual-novel-ui/reader-host-constants.js", function(module, exports, require) {
...
__vnDefine(exports, "DEFAULT_IMAGE_API", () => DEFAULT_IMAGE_API);
__vnDefine(exports, "VN_THEME_PRESETS", () => VN_THEME_PRESETS);
__vnDefine(exports, "READER_REQUIRED_SETTINGS_PATHS", () => READER_REQUIRED_SETTINGS_PATHS);
__vnDefine(exports, "SETTINGS_PANEL_REQUIRED_SELECTORS", () => SETTINGS_PANEL_REQUIRED_SELECTORS);
__vnDefine(exports, "SETTINGS_PANEL_TAB_CONTRACT", () => SETTINGS_PANEL_TAB_CONTRACT);
__vnDefine(exports, "TOOLBAR_ACTIONS", () => TOOLBAR_ACTIONS);
__vnDefine(exports, "DEFAULT_PINNED_TOOLBAR_BUTTONS", () => DEFAULT_PINNED_TOOLBAR_BUTTONS);
__vnDefine(exports, "READER_SETTINGS_SCHEMA_VERSION", () => READER_SETTINGS_SCHEMA_VERSION);
__vnDefine(exports, "INITIAL_IMAGE_POLL_ATTEMPTS", () => INITIAL_IMAGE_POLL_ATTEMPTS);
__vnDefine(exports, "INITIAL_IMAGE_POLL_INTERVAL_MS", () => INITIAL_IMAGE_POLL_INTERVAL_MS);
__vnDefine(exports, "DEFAULT_SCENE_PROMPT_RULE", () => DEFAULT_SCENE_PROMPT_RULE);
});
__vnRegister("src/visual/visual-novel-ui/reader-value-utils.js", function(module, exports, require) {
const { looksLikeHostUiHtml } = require("src/scene/message-source.js");
function vnDebugEnabled() {
    try {
...
__vnDefine(exports, "vnDebugEnabled", () => vnDebugEnabled);
__vnDefine(exports, "vnDebug", () => vnDebug);
__vnDefine(exports, "esc", () => esc);
__vnDefine(exports, "cloneData", () => cloneData);
__vnDefine(exports, "firstDefined", () => firstDefined);
__vnDefine(exports, "firstNonEmptyString", () => firstNonEmptyString);
__vnDefine(exports, "normalizeBoolean", () => normalizeBoolean);
__vnDefine(exports, "normalizeOpacity", () => normalizeOpacity);
__vnDefine(exports, "normalizeFiniteNumber", () => normalizeFiniteNumber);
__vnDefine(exports, "normalizeNullableNumber", () => normalizeNullableNumber);
__vnDefine(exports, "normalizeFiniteIndex", () => normalizeFiniteIndex);
__vnDefine(exports, "clampNumber", () => clampNumber);
__vnDefine(exports, "toHex", () => toHex);
__vnDefine(exports, "computeLineHeight", () => computeLineHeight);
__vnDefine(exports, "normalizeDisplayText", () => normalizeDisplayText);
__vnDefine(exports, "firstRenderableText", () => firstRenderableText);
__vnDefine(exports, "stripSpeakerPrefix", () => stripSpeakerPrefix);
});
__vnRegister("src/visual/visual-novel-ui/settings-fields.js", function(module, exports, require) {
const { esc } = require("src/visual/visual-novel-ui/reader-value-utils.js");
const { TOOLBAR_ACTIONS } = require("src/visual/visual-novel-ui/reader-host-constants.js");
...
__vnDefine(exports, "renderTemplate", () => renderTemplate);
__vnDefine(exports, "field", () => field);
__vnDefine(exports, "disabledAttr", () => disabledAttr);
__vnDefine(exports, "textInput", () => textInput);
__vnDefine(exports, "colorInput", () => colorInput);
__vnDefine(exports, "textareaInput", () => textareaInput);
__vnDefine(exports, "secretInput", () => secretInput);
__vnDefine(exports, "numberInput", () => numberInput);
__vnDefine(exports, "checkbox", () => checkbox);
__vnDefine(exports, "selectInput", () => selectInput);
__vnDefine(exports, "segmentedInput", () => segmentedInput);
__vnDefine(exports, "modelPicker", () => modelPicker);
__vnDefine(exports, "renderSceneAssetList", () => renderSceneAssetList);
__vnDefine(exports, "renderCharacterAssetList", () => renderCharacterAssetList);
__vnDefine(exports, "renderPinnedButtons", () => renderPinnedButtons);
});
__vnRegister("src/visual/visual-novel-ui/reader-image-state.js", function(module, exports, require) {
const { cloneData, firstDefined, normalizeFiniteIndex, normalizeNullableNumber } = require("src/visual/visual-novel-ui/reader-value-utils.js");
const { INITIAL_IMAGE_POLL_ATTEMPTS, INITIAL_IMAGE_POLL_INTERVAL_MS } = require("src/visual/visual-novel-ui/reader-host-constants.js");
...
__vnDefine(exports, "shouldPollReaderImages", () => shouldPollReaderImages);
__vnDefine(exports, "countBoundImageSlots", () => countBoundImageSlots);
__vnDefine(exports, "normalizePollInterval", () => normalizePollInterval);
__vnDefine(exports, "normalizePollAttempts", () => normalizePollAttempts);
__vnDefine(exports, "waitForReaderImagePoll", () => waitForReaderImagePoll);
__vnDefine(exports, "buildProgressText", () => buildProgressText);
__vnDefine(exports, "normalizeSnapshotImageState", () => normalizeSnapshotImageState);
__vnDefine(exports, "applyImageCountOverride", () => applyImageCountOverride);
__vnDefine(exports, "buildImageActionContext", () => buildImageActionContext);
__vnDefine(exports, "resolveSegmentImageIndex", () => resolveSegmentImageIndex);
__vnDefine(exports, "mapSnapshotImageEntry", () => mapSnapshotImageEntry);
__vnDefine(exports, "resolveSnapshotDisplayImage", () => resolveSnapshotDisplayImage);
__vnDefine(exports, "resolveIndexedSnapshotUnboundImage", () => resolveIndexedSnapshotUnboundImage);
});
__vnRegister("src/visual/visual-novel-ui/reader-dom-utils.js", function(module, exports, require) {
...
__vnDefine(exports, "getRootDocument", () => getRootDocument);
__vnDefine(exports, "getOwnerWindow", () => getOwnerWindow);
__vnDefine(exports, "clearChildren", () => clearChildren);
__vnDefine(exports, "ensureStyleTag", () => ensureStyleTag);
__vnDefine(exports, "unmountNode", () => unmountNode);
__vnDefine(exports, "readElementWidth", () => readElementWidth);
__vnDefine(exports, "readElementHeight", () => readElementHeight);
__vnDefine(exports, "normalizeBoxMeasure", () => normalizeBoxMeasure);
__vnDefine(exports, "readNumericPixels", () => readNumericPixels);
__vnDefine(exports, "ensureImageLoadingSpinner", () => ensureImageLoadingSpinner);
__vnDefine(exports, "removeImageLoadingSpinner", () => removeImageLoadingSpinner);
__vnDefine(exports, "attachSettingsViewportEvents", () => attachSettingsViewportEvents);
__vnDefine(exports, "detachSettingsViewportEvents", () => detachSettingsViewportEvents);
__vnDefine(exports, "syncSettingsViewportVars", () => syncSettingsViewportVars);
});
__vnRegister("src/visual/visual-novel-ui/settings-normalize.js", function(module, exports, require) {
const { LEGACY_READER_MODES, resolveLegacyReaderMode } = require("src/storage/legacy-visual-novel.js");
const { buildNarrativeSegments } = require("src/scene/image-slots.js");
const { SETTINGS_TAB_DEFS } = require("src/visual/visual-novel-ui/settings-tabs.js");
const { TOOLBAR_ACTIONS, VN_THEME_PRESETS } = require("src/visual/visual-novel-ui/reader-host-constants.js");
const { esc, normalizeFiniteNumber } = require("src/visual/visual-novel-ui/reader-value-utils.js");
...
__vnDefine(exports, "normalizeReaderMode", () => normalizeReaderMode);
__vnDefine(exports, "normalizeSettingsTab", () => normalizeSettingsTab);
__vnDefine(exports, "normalizeSettingsValue", () => normalizeSettingsValue);
__vnDefine(exports, "getPath", () => getPath);
__vnDefine(exports, "setPath", () => setPath);
__vnDefine(exports, "buildTextSegments", () => buildTextSegments);
__vnDefine(exports, "normalizePinnedButtons", () => normalizePinnedButtons);
__vnDefine(exports, "normalizeHiddenButtons", () => normalizeHiddenButtons);
__vnDefine(exports, "normalizeBtnOrder", () => normalizeBtnOrder);
__vnDefine(exports, "normalizeSpriteLayouts", () => normalizeSpriteLayouts);
__vnDefine(exports, "resolveSpriteLayout", () => resolveSpriteLayout);
__vnDefine(exports, "resolveActiveTheme", () => resolveActiveTheme);
__vnDefine(exports, "renderDialogueHtml", () => renderDialogueHtml);
});
__vnRegister("src/visual/visual-novel-ui/reader-runtime.js", function(module, exports, require) {
const { getOwnerWindow } = require("src/visual/visual-novel-ui/reader-dom-utils.js");
const { clampNumber } = require("src/visual/visual-novel-ui/reader-value-utils.js");
...
__vnDefine(exports, "applyReaderModeRuntime", () => applyReaderModeRuntime);
__vnDefine(exports, "clearReaderModeRuntime", () => clearReaderModeRuntime);
__vnDefine(exports, "addRuntimeCleanup", () => addRuntimeCleanup);
__vnDefine(exports, "exitDocumentFullscreen", () => exitDocumentFullscreen);
});
__vnRegister("src/visual/visual-novel-ui/sprite-edit.js", function(module, exports, require) {
const { resolveSpriteLayout } = require("src/visual/visual-novel-ui/settings-normalize.js");const { vnDebug } = require("src/visual/visual-novel-ui/reader-value-utils.js");
...
__vnDefine(exports, "enterSpriteEditMode", () => enterSpriteEditMode);
__vnDefine(exports, "exitSpriteEditMode", () => exitSpriteEditMode);
});
__vnRegister("src/visual/visual-novel-ui/settings-actions.js", function(module, exports, require) {
const { DEFAULT_VIRTUAL_REGEX } = require("src/scene/message-source.js");
const { cloneData } = require("src/visual/visual-novel-ui/reader-value-utils.js");
const { DEFAULT_SCENE_PROMPT_RULE, TOOLBAR_ACTIONS } = require("src/visual/visual-novel-ui/reader-host-constants.js");
...
__vnDefine(exports, "handleSettingsAction", () => handleSettingsAction);
});
__vnRegister("src/visual/visual-novel-ui/reader-dom-render.js", function(module, exports, require) {
const { ORIGINAL_READER_ICONS, ORIGINAL_READER_TOOLBAR_BUTTONS } = require("src/visual/visual-novel-ui/original-reader-source.js");const { TOOLBAR_ACTIONS } = require("src/visual/visual-novel-ui/reader-host-constants.js");const { ensureImageLoadingSpinner, getOwnerWindow, readElementHeight, readElementWidth, removeImageLoadingSpinner } = require("src/visual/visual-novel-ui/reader-dom-utils.js");const { computeLineHeight, normalizeOpacity, vnDebug } = require("src/visual/visual-novel-ui/reader-value-utils.js");const { renderDialogueHtml, resolveActiveTheme, resolveSpriteLayout } = require("src/visual/visual-novel-ui/settings-normalize.js");const { applyReaderModeRuntime } = require("src/visual/visual-novel-ui/reader-runtime.js");
...
__vnDefine(exports, "createReaderButton", () => createReaderButton);
__vnDefine(exports, "buildFallbackReaderOverlay", () => buildFallbackReaderOverlay);
__vnDefine(exports, "buildFallbackSettingsOverlay", () => buildFallbackSettingsOverlay);
__vnDefine(exports, "applyToolbarState", () => applyToolbarState);
__vnDefine(exports, "applyReaderSettingsToDom", () => applyReaderSettingsToDom);
__vnDefine(exports, "applyReaderSnapshotToDom", () => applyReaderSnapshotToDom);
});
