...
const { buildVisualNovelTextPayload, DEFAULT_VIRTUAL_REGEX, getMessagePrimaryText, looksLikeHostUiHtml, normalizeSourceFilter, normalizeVirtualRegex } = require("src/scene/message-source.js");
const { buildNarrativeSegments } = require("src/scene/image-slots.js");
const { getOriginalReaderHtml, ORIGINAL_READER_ICONS, getOriginalReaderSource, getOriginalReaderStyleText, ORIGINAL_READER_REQUIRED_SELECTORS, ORIGINAL_READER_STYLE_CONTRACT, ORIGINAL_READER_TOOLBAR_BUTTONS } = require("src/visual/visual-novel-ui/original-reader-source.js");
const { getSettingsShellTemplate } = require("src/visual/visual-novel-ui/settings-shell.js");
const { getSettingsStyleText } = require("src/visual/visual-novel-ui/settings-style.js");
const { getSettingsTabTemplate, SETTINGS_TAB_DEFS } = require("src/visual/visual-novel-ui/settings-tabs.js");
const { getReaderModeIcon } = require("src/visual/visual-novel-ui/icons.js");
...
function getOriginalReaderSource(version = '0.3.18') {
    return {
        version,
