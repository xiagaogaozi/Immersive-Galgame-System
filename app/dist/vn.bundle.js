...
const { resolveSpriteLayout } = require("src/visual/visual-novel-ui/settings-normalize.js");
...
const { ORIGINAL_READER_ICONS, ORIGINAL_READER_TOOLBAR_BUTTONS } = require("src/visual/visual-novel-ui/original-reader-source.js");
const { TOOLBAR_ACTIONS } = require("src/visual/visual-novel-ui/reader-host-constants.js");
const { ensureImageLoadingSpinner, getOwnerWindow, readElementHeight, readElementWidth, removeImageLoadingSpinner } = require("src/visual/visual-novel-ui/reader-dom-utils.js");
const { computeLineHeight, normalizeOpacity } = require("src/visual/visual-novel-ui/reader-value-utils.js");
const { renderDialogueHtml, resolveActiveTheme, resolveSpriteLayout } = require("src/visual/visual-novel-ui/settings-normalize.js");
const { applyReaderModeRuntime } = require("src/visual/visual-novel-ui/reader-runtime.js");
