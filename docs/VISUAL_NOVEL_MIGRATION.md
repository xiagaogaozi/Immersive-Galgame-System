...
- 本轮实际对照源优先使用这些文件：
  ...
  - `Visual Novel/tavern helper/bridge/src/ui/settings/shell.html`
  - `Visual Novel/tavern helper/bridge/src/ui/settings/style.css`
  - `Visual Novel/tavern helper/bridge/src/ui/settings/tabs/basic.html`
  - `Visual Novel/tavern helper/bridge/src/ui/settings/tabs/regex.html`
  - `Visual Novel/tavern helper/bridge/src/ui/settings/tabs/image.html`
  - `Visual Novel/tavern helper/bridge/src/ui/settings/tabs/reader.html`
  - `Visual Novel/tavern helper/bridge/src/ui/shared/icons.js`
...
- 不挂载 `window.VisualNovelBridge` 旧全局别名。
- 不实现真实设置面板。
- 不实现真实 provider 请求。
...
- 不把 `window.VisualNovelBridge` 旧全局别名重新挂回。
