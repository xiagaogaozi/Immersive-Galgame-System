...
```text
app/src/** -> npm run build -> app/dist/vn.bundle.js + app/dist/vn.bundle.css -> loader/vn-loader.js -> loader/vn-loader.json
```
...
- `loader/vn-loader.js` 只负责加载远程 bundle，不写业务逻辑。
- `loader/vn-loader.json` 的 `content` 必须等于 `loader/vn-loader.js` 原文。
