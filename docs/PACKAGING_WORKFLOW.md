...
```text
projects/<当前本地项目文件夹> 原版备份/project.json
projects/<当前本地项目文件夹> 原版备份/tavern helper/bridge/src/source.js
projects/<当前本地项目文件夹> 原版备份/tavern helper/bridge/src/index.js
projects/<当前本地项目文件夹> 原版备份/tavern helper/bridge/src/ui/reader/original-reader.js
projects/<当前本地项目文件夹> 原版备份/latest/酒馆助手脚本-沉浸式galgame系统 v9.6.6.json
projects/<当前本地项目文件夹> 原版备份/latest/Immersive Galgame System v9.6.6.js
```
...
`git rev-parse --show-toplevel` 必须返回 `<当前项目目录>`。如果标签已存在，不强推覆盖，提升 patch 版本后重新发布。
